...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- 登录表单 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <div class=\"login_main_mid\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <div class=\"login_content_top\">请登录Estore商场</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <div class=\"login_content_line\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <form action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/login\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <dl class=\"login_content\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <dt>email：</dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <dd><input id=\"email\" name=\"email\" value=\"");
      ...
      out.write("\" type=\"text\" class=\"login_content_input\" /></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <dl class=\"login_content\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <dt>密码：</dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <dd>\r\n");
      ...
      out.write("\" type=\"password\" class=\"login_content_input\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       </dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <dl class=\"login_content\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     \t<dt></dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     \t<dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     \t<input type=\"checkbox\" name=\"remember\" value=\"on\"/>记住用户 \r\n");
      out.write("\t\t\t\t\t\t\t\t\t     \t</dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <dl class=\"login_content\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <dt></dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <dd><div style=\"color:red;\">");
      ...
      out.write("</div><input id=\"btn\" value=\" \" type=\"submit\" class=\"login_btn_out\" /></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </form>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <div class=\"login_content_dotted\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <div class=\"login_content_end_bg\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <div class=\"login_content_end_bg_top\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <label class=\"login_content_bold\">还不是Estore商场用户？</label>快捷方便的免费注册，让你立刻尽享Estore商场提供的满意服务......\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     <div class=\"login_content_end_bg_end\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <input  class=\"login_register_out\" value=\" \" type=\"button\" onclick=\"window.location='regist.jsp';\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <!-- 登录表单结束 -->                        \r\n");
