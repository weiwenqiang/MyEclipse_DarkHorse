...
public final class regist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t    <div class=\"register_title_bg\"><h3>欢迎注册Estore商城</h3>您所提供的资料不会做其他用途，敬请安心填写。</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t    <div class=\"register_dotted_bg\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t    <div class=\"register_message\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t    <form action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/regist\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <dl class=\"register_row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <dt>Email地址：</dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <dd><input id=\"email\" name=\"email\" type=\"text\" class=\"register_input\"/></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t      </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t      <dl class=\"register_row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <dt>设置昵称：</dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <dd><input id=\"nickName\" name=\"nickname\" type=\"text\" class=\"register_input\"/></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <dd></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t      </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <dl class=\"register_row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <dt>设定密码：</dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <dd><input id=\"pwd\" name=\"password\" type=\"password\" class=\"register_input\"/></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     </dl> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <dl class=\"register_row\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <dt>再输入一次密码：</dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         <dd><input id=\"repwd\" name=\"repassword\" type=\"password\" class=\"register_input\"/></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     <dl class=\"register_row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <dt>验证码：</dt>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <dd><input name=\"checkcode\" class=\"register_input\" type=\"text\" /> </dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t        <dd><img id=\"loginform:vCode\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/validatecode.jsp\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"javascript:document.getElementById('loginform:vCode').src='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/validatecode.jsp?'+Math.random();\" /></dd>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t     </dl>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t      <div class=\"registerBtn\"><div style=\"color:red\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${error_msg }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("</div><input id=\"registerBtn\" type=\"image\" src=\"images/register_btn_out.gif\" /></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   </form>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  <!-- 注册表单结束 -->                        \r\n");
